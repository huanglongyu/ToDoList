...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private String[] statements = {
            ...
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test5', '7', '0', '5');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test6', '7', '0', '6');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test7', '7', '0', '7');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test8', '7', '0', '8');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test9', '7', '0', '9');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test10', '7', '1', '10');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test11', '7', '1', '11');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test12', '7', '1', '12');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test13', '7', '1', '13');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test14', '7', '1', '14');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test15', '7', '1', '15');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test16', '7', '1', '16');",
            "INSERT INTO " + TABLE_NAME + "(_id," +  CONTENT + "," + COLOR + "," +  DONE + "," + TIME_STAMP +") VALUES (NULL, 'test17', '7', '1', '17');"
